...
void GatePulseProcessorChainMessenger::DoInsertion(const G4String& childTypeName)
{
  ...
  if (childTypeName=="readout")
    ...
    newProcessor = new GateBlurring(GetProcessorChain(),newInsertionName,-1.,-1.*keV);
