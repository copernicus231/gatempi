...
GatePhysicsList::GatePhysicsList(): G4VUserPhysicsList() 
{
  ...
  worldCuts.gammaCut = 0;
  worldCuts.electronCut = 0;
  worldCuts.positronCut = 0;
...
void GatePhysicsList::DefineCuts()
{
  ...
  if (worldCuts.gammaCut == 0) worldCuts.gammaCut = defaultCutValue;
  if (worldCuts.electronCut == 0) worldCuts.electronCut = defaultCutValue;
  if (worldCuts.positronCut == 0) worldCuts.positronCut = defaultCutValue;
