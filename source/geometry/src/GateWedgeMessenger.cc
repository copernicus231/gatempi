...
{ 
  G4String cmdName = GetDirectoryName()+"setXLength";
  ...
  cmdName = GetDirectoryName()+"setNarrowerXLength";
  ...
  cmdName = GetDirectoryName()+"setYLength";
  ...
  cmdName = GetDirectoryName()+"setZLength";
